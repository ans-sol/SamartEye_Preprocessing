...
def main():
    ...
    argparser.add_argument(
        '--max-speed',
        metavar='MS',
        default=30.0,  # Default max speed in m/s (e.g., 30 m/s ≈ 108 km/h)
        type=float,
        help='Maximum speed for vehicles in m/s (default: 30.0)')
    ...
    try:
        ...
        if not blueprints:
            raise ValueError("Couldn't find any of the target vehicles in the blueprint library.")
        ...
        for spawn_point in spawn_points:
            walker_bp = random.choice(world.get_blueprint_library().filter(args.filterw))
